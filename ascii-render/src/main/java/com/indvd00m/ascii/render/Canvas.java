...
public class Canvas implements ICanvas {
	...
	/**
	 * rapresenta il testo contenente Canvas con il metodo String in modo protetto
	 */
	// cache
	...
	/**
	 * implementa le chache di Canvas
	 * la chache viene salvata in nei file cachedLines e cachedText.
	 */
	...
	/**
	 * Con l'override mi prende i parametri e metodi della classe padre
	 *
	 * @param x
	 * @param y
	 * @param c
	...
	public void draw(int x, int y, String s) {
		...
		/**
		 * Qui ci sono delle condizioni che dicono se y < 0, x < 0, x < 0 e vero.
		 */
		// single line string
		if (y < 0) {
			return;
